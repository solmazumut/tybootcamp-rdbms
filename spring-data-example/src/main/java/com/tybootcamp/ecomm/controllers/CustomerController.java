...
import com.tybootcamp.ecomm.entities.CustomerProfile;
...
public class CustomerController {
    ...
    @PostMapping(path = "/")
    public ResponseEntity<Customer> addNewSeller(@Valid @RequestBody Customer customer)
    {
        Customer customerEntity = new Customer(customer.getAccountId());
        CustomerProfile profile = new CustomerProfile(customerEntity, customer.getProfile().getFirstName(), customer.getProfile().getLastName(), customer.getProfile().getGender());
